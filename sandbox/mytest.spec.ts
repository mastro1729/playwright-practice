...
/* test.only('Title Test', async ({page, browserName}) => {
...
test.skip('URL Test', async ({page}) => {
    await page.goto('https://www.w3schools.com/');
    await expect(page).toHaveURL(/.*w3schools.*/);
})

test.fixme('Header Visibility Test', async ({page}) => {
    await page.goto('https://www.w3schools.com/');
...
test('Google Search Icon Visibility Test', async ({page}) => {
    test.fail();
    await page.goto('https://www.w3schools.com/');
    let googleSearchIcon = page.locator(`//*[name()='svg' and @id='tnb-google-search-iconn']`);
...
test('W3Schools Certificates Visibility Test', async ({page}) => {
    ...
    await page.goto('https://www.w3schools.com/');
    let W3SCerts = page.locator(`//div[@class='tnb-right-section']/a[@title='W3Schools Certificates']/*[name()='svg']`).first();
